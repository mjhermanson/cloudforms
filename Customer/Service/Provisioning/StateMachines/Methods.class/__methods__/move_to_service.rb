#
# Description: move a Service or VM into another service. Called from a button on an object (vmdb_object_type)
#
begin
  parent_service_id = $evm.root['dialog_service_name']
