...
def emailrequester(miq_request, appliance)
  ...
  body += "<br><br>To view this Request go to: <a href='https://svdlknxcloudformsui01.servers.global.prv/miq_request/show/#{miq_request.id}'>https://svdlknxcloudformsui01.servers.global.prv/miq_request/show/#{miq_request.id}</a>"
