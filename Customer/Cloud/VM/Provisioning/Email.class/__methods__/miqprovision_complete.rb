...
body += "<br><br>If you are not already logged in, you can access and manage your virtual machine here <a href='https://svdlknxcloudformsui01.servers.global.prv/vm_or_template/show/#{vm['id']}'>https://svdlknxcloudformsui01.servers.global.prv/vm_or_template/show/#{vm['id']}'</a>"
