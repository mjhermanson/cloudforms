...
def emailrequester(miq_request, appliance, msg, provisionRequestApproval)
  ...
  body += "<br><br>For more information you can go to: <a href='https://svdlknxcloudformsui01.servers.global.prv/miq_request/show/#{miq_request.id}'>https://svdlknxcloudformsui01.servers.global.prv/miq_request/show/#{miq_request.id}</a>"
